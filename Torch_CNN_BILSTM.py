...
path_dataset_train = 'Train Dataset Directory : '
path_dataset_val = 'Validation Dataset Directory : '
...
file = '/mnt/data/sviola/result_test/matrix_result.npy'
np.save(file, matrix_result_test, allow_pickle=True)
file = '/mnt/data/sviola/result_test/f1_data_score.npy'
